...
public class MyCartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add(new CartModel(R.drawable.s2,"Order 1","R$20","4.6"));
        list.add(new CartModel(R.drawable.fav1,"Order 1","40","4.4"));
        list.add(new CartModel(R.drawable.s1,"Order 1","R$30","4.3"));
        list.add(new CartModel(R.drawable.s1,"Order 1","R$20","4.3"));
