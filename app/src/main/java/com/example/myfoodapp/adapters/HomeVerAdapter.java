    ...
    public void onBindViewHolder(@NonNull HomeVerAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView bottomName = sheetView.findViewById(R.id.bottom_name);
                ImageView bottomPrice = sheetView.findViewById(R.id.bottom_price);
                ImageView bottomRating = sheetView.findViewById(R.id.bottom_rating);

                bottomName.setTextDirection(Integer.parseInt(mName));
                bottomPrice.setTextDirection(Integer.parseInt(mPrice));
                bottomRating.setTextDirection(Integer.parseInt(mRating));
